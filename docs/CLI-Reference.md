...
An optional positional argument (`exploit`, `scanner`, `creds`, `osint`, `post`, `plugins`) can be used to specify the module category, but it is not required -- the dispatcher resolves modules by name automatically.
