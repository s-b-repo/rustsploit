...
|| [Module Catalog](Module-Catalog.md) | Live registry export — auto-generated by `rustsploit --gen-module-catalog` from the inventory (389 modules) |
...
|| [Changelog](Changelog.md) | Release notes and version history (latest: v0.5.0 — 2026-06-13: rmcp / Recog / JARM / SecLists ports, mass-scan fixes, per-run auto-save, 389 modules) |
