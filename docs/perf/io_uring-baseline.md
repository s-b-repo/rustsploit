# io_uring migration — benchmark results (before / after)

The BEFORE half was captured **2026-06-27**, before any io_uring/tokio-uring
work; the AFTER and sharded halves below are the post-migration runs on the
same host — one document, apples-to-apples. Migration design and status log:
[io_uring-migration-plan.md](io_uring-migration-plan.md).
