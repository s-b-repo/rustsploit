...
Started 2026-06-27. Companion to `io_uring-baseline.md` (the BEFORE numbers).
...
`tcp_port_open` stays `Send` and the 380 modules are untouched. The **main
...
- Follow-up (done 2026-06-30): stream-connect added. RingRequest::Connect dispatches
  ...
  on and no source port is set. All 380+ modules benefit automatically.
