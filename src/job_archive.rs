...
/// Maximum output size per job (10MB)
pub const MAX_OUTPUT_SIZE: usize = 10 * 1024 * 1024;

/// Maximum jobs in memory before archiving
const MAX_MEMORY_JOBS: usize = 100;
...
impl Default for JobArchive {
    fn default() -> Self {
        Self::new().expect("Failed to create default JobArchive")
    }
}
